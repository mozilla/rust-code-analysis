...
//! This crate provides Ccomment grammar support for the [tree-sitter][] parsing library.
//!
...
extern "C" {
    fn tree_sitter_ccomment() -> *const ();
}

/// The tree-sitter [`LanguageFn`][LanguageFn] for this grammar.
///
/// [LanguageFn]: https://docs.rs/tree-sitter-language/*/tree_sitter_language/struct.LanguageFn.html
pub const LANGUAGE: LanguageFn = unsafe { LanguageFn::from_raw(tree_sitter_ccomment) };
