...
pub enum Rust {
    ...
    EnumVariantList = 162,
    EnumVariant = 163,
    FieldDeclarationList = 164,
    FieldDeclaration = 165,
    OrderedFieldDeclarationList = 166,
    ExternCrateDeclaration = 167,
    ConstItem = 168,
    StaticItem = 169,
    TypeItem = 170,
    FunctionItem = 171,
    FunctionSignatureItem = 172,
    FunctionModifiers = 173,
    WhereClause = 174,
    WherePredicate = 175,
    ImplItem = 176,
    TraitItem = 177,
    AssociatedType = 178,
    TraitBounds = 179,
    HigherRankedTraitBound = 180,
    RemovedTraitBound = 181,
    TypeParameters = 182,
    ConstParameter = 183,
    ConstrainedTypeParameter = 184,
    OptionalTypeParameter = 185,
    LetDeclaration = 186,
    UseDeclaration = 187,
    UseClause = 188,
    ScopedUseList = 189,
    ...
    Parameters = 193,
    SelfParameter = 194,
    VariadicParameter = 195,
    Parameter = 196,
    ExternModifier = 197,
    VisibilityModifier = 198,
    Type2 = 199,
    BracketedType = 200,
    QualifiedType = 201,
    Lifetime = 202,
    ...
    AbstractType = 217,
    DynamicType = 218,
    ExpressionExceptRange = 219,
    Expression = 220,
    MacroInvocation = 221,
    ScopedIdentifier = 222,
    ScopedTypeIdentifier = 223,
    ScopedTypeIdentifier2 = 224,
    RangeExpression = 225,
    UnaryExpression = 226,
    TryExpression = 227,
    ReferenceExpression = 228,
    BinaryExpression = 229,
    AssignmentExpression = 230,
    CompoundAssignmentExpr = 231,
    TypeCastExpression = 232,
    ReturnExpression = 233,
    YieldExpression = 234,
    CallExpression = 235,
    Arguments = 236,
    ArrayExpression = 237,
    ...
    TupleExpression = 239,
    UnitExpression = 240,
    StructExpression = 241,
    FieldInitializerList = 242,
    ShorthandFieldInitializer = 243,
    FieldInitializer = 244,
    BaseFieldInitializer = 245,
    IfExpression = 246,
    IfLetExpression = 247,
    ElseClause = 248,
    MatchExpression = 249,
    ...
    MatchPattern = 253,
    WhileExpression = 254,
    WhileLetExpression = 255,
    LoopExpression = 256,
    ForExpression = 257,
    ConstBlock = 258,
    ClosureExpression = 259,
    ClosureParameters = 260,
    LoopLabel = 261,
    BreakExpression = 262,
    ContinueExpression = 263,
    IndexExpression = 264,
    AwaitExpression = 265,
    FieldExpression = 266,
    UnsafeBlock = 267,
    ...
    TuplePattern = 271,
    SlicePattern = 272,
    TupleStructPattern = 273,
    StructPattern = 274,
    FieldPattern = 275,
    RemainingFieldPattern = 276,
    MutPattern = 277,
    RangePattern = 278,
    RefPattern = 279,
    CapturedPattern = 280,
    ReferencePattern = 281,
    OrPattern = 282,
    Literal2 = 283,
    LiteralPattern = 284,
    NegativeLiteral = 285,
    StringLiteral = 286,
    BooleanLiteral = 287,
    SourceFileRepeat1 = 288,
    MacroDefinitionRepeat1 = 289,
    TokenTreePatternRepeat1 = 290,
    TokenTreeRepeat1 = 291,
    MetaArgumentsRepeat1 = 292,
    DeclarationListRepeat1 = 293,
    EnumVariantListRepeat1 = 294,
    EnumVariantListRepeat2 = 295,
    FieldDeclarationListRepeat1 = 296,
    OrderedFieldDeclarationListRepeat1 = 297,
    FunctionModifiersRepeat1 = 298,
    WhereClauseRepeat1 = 299,
    TraitBoundsRepeat1 = 300,
    TypeParametersRepeat1 = 301,
    UseListRepeat1 = 302,
    ParametersRepeat1 = 303,
    ForLifetimesRepeat1 = 304,
    TupleTypeRepeat1 = 305,
    TypeArgumentsRepeat1 = 306,
    ArgumentsRepeat1 = 307,
    ArrayExpressionRepeat1 = 308,
    TupleExpressionRepeat1 = 309,
    FieldInitializerListRepeat1 = 310,
    MatchBlockRepeat1 = 311,
    ClosureParametersRepeat1 = 312,
    TuplePatternRepeat1 = 313,
    StructPatternRepeat1 = 314,
    StringLiteralRepeat1 = 315,
    FieldIdentifier = 316,
    ShorthandFieldIdentifier = 317,
    TypeIdentifier = 318,
    Error = 319,
}
