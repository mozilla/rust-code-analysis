...
pub enum Tsx {
    ...
    DefaultType = 279,
    Constraint = 280,
    ConstructSignature = 281,
    IndexSignature = 282,
    ArrayType = 283,
    TupleType = 284,
    UnionType = 285,
    IntersectionType = 286,
    FunctionType = 287,
    ProgramRepeat1 = 288,
    ExportStatementRepeat1 = 289,
    ExportClauseRepeat1 = 290,
    NamedImportsRepeat1 = 291,
    VariableDeclarationRepeat1 = 292,
    SwitchBodyRepeat1 = 293,
    ObjectRepeat1 = 294,
    ArrayRepeat1 = 295,
    JsxElementRepeat1 = 296,
    JsxOpeningElementRepeat1 = 297,
    StringRepeat1 = 298,
    StringRepeat2 = 299,
    TemplateStringRepeat1 = 300,
    ClassBodyRepeat1 = 301,
    FormalParametersRepeat1 = 302,
    ImplementsClauseRepeat1 = 303,
    ExtendsClauseRepeat1 = 304,
    EnumBodyRepeat1 = 305,
    ObjectTypeRepeat1 = 306,
    TypeParametersRepeat1 = 307,
    TypeIdentifier = 308,
    ArrayPattern = 309,
    ShorthandPropertyIdentifier = 310,
    PropertyIdentifier = 311,
    ObjectPattern = 312,
    ImportSpecifier = 313,
    ExportSpecifier = 314,
