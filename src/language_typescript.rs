...
pub enum Typescript {
    ...
    DefaultType = 270,
    Constraint = 271,
    ConstructSignature = 272,
    IndexSignature = 273,
    ArrayType = 274,
    TupleType = 275,
    UnionType = 276,
    IntersectionType = 277,
    FunctionType = 278,
    ProgramRepeat1 = 279,
    ExportStatementRepeat1 = 280,
    ExportClauseRepeat1 = 281,
    NamedImportsRepeat1 = 282,
    VariableDeclarationRepeat1 = 283,
    SwitchBodyRepeat1 = 284,
    ObjectRepeat1 = 285,
    ArrayRepeat1 = 286,
    StringRepeat1 = 287,
    StringRepeat2 = 288,
    TemplateStringRepeat1 = 289,
    ClassBodyRepeat1 = 290,
    FormalParametersRepeat1 = 291,
    ImplementsClauseRepeat1 = 292,
    ExtendsClauseRepeat1 = 293,
    EnumBodyRepeat1 = 294,
    ObjectTypeRepeat1 = 295,
    TypeParametersRepeat1 = 296,
    TypeIdentifier = 297,
    ArrayPattern = 298,
    ShorthandPropertyIdentifier = 299,
    PropertyIdentifier = 300,
    ObjectPattern = 301,
    ImportSpecifier = 302,
    ExportSpecifier = 303,
