...
unsigned tree_sitter_javascript_external_scanner_mozjs_serialize(void *payload, char *buffer) { return 0; }
...
bool tree_sitter_javascript_external_scanner_mozjs_scan(void *payload, TSLexer *lexer, const bool *valid_symbols) {
